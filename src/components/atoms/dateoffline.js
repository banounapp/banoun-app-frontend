...
export const DateOffline = ({clientname, caseattend,date,linkdate}) => {
  return (
   <>
   <div>
   <a href="#">
   ...
   <div className="rounded-lg mt-5 bg-silver-tree-300 lg:w-11/12 lg:h-32 text-base md:text-xl lg:text-lg">
