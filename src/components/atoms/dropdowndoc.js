...
export const DropDownDoc = ({ parent, child1, child2, child3, child4, child5 }) => {
  return (
    <div className="dropdown bg-white text-gray-600 relative w-9/12 mt-2 md:w-4/12  md:mt-2 md:m-auto lg:w-2/12 lg:mr-5 border-2 border-pale-leaf-500  rounded">
