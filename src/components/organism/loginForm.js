...
const FormFieldLogin = ({ history, dispatch }) => {
  ...
  const validate = Yup.object({
    username: Yup.string().max(15, "لابد ان تكون 15 حرف على الاقل").required("مطلوب"),
    password: Yup.string().min(6, "لابد ان يكون 6 ارقام على الاقل").required("مطلوب"),
  });
  ...
  return (
    ...
    >
      {(formik) => (
        <Form action="#" className="text-center  m-auto md:m-auto justify-center  ">
