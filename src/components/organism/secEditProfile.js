...
const EditProfile = ({ GetUer, user }) => {
  ...
  return (
    <div className='bg-white w-60 pt-4 pb-4 md:w-96 m-auto pt-5 lg:w-1/4 lg:mt-14 lg:sticky lg:top-0 '>
      <div className=''>
        {user &&user.image ?<img src={`https://banoun-app.herokuapp.com/api/upload/show/${user.image}`}
        className='m-auto rounded-full w-32 md:w-44 mb-5 lg:w-60' />:<img src="https://freepikpsd.com/media/2019/10/avtar-png-9.png"
