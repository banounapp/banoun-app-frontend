...
export const Section1 = () => {
  return (
   <div className=" bg-silver-tree-300">
...
<div className=" grid lg:grid-cols-3 mr-24  h-4/5">
  <div className="ml-10">
    <Card
stylee="lg:w-full -mt-1 lg:mt-20 -mr-7 lg:mr-12"
category="الحمل"
imageSource="images/card1.png"

/>
<Card
stylee="lg:w-full -mt-1 lg:mt-72 -mr-7 lg:mr-12"
category="الطفوله"
...
/>
  ...
  <div className=" hidden lg:block z-10"><img src="images/tree.png" className=""/></div>
  <div className="ml-10">
  <Card
stylee="lg:w-full -mt-1 -mr-7 lg:mt-80 lg:-mr-2 "
category="ما بعد الولاده"
imageSource="images/card4.png"

/>
<Card
stylee="lg:w-full -mt-1 -mr-7 lg:mt-72 lg:-mr-2"
category="المراهقه"
imageSource="images/card5.png"
