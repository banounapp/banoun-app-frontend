      ...
      {!books ? (
        ...
        <div className=" px-32 ">
          <div className=" lg:flex justify-between	 ">
            <h2 className="text-base md:text-lg lg:text-2xl lg:px-10">
              كتب الموصى بها
            </h2>
            <a href="#" className="text-silver-tree-600">
              <h2 className="text-sm md:text-base lg:text-lg silver-tree-700">
                عرض المزيد
              </h2>
            </a>
          </div>
