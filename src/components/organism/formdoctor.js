...
import { uploadImg } from "./../../redux/actions/registerSpecialist";
  ...
  return (
    <div>
      <div class="grid grid-cols-1 divide-y divide-sazerac-500 w-full">
        <p className="text-sm mt-4 ml-10 md:text-lg lg:text-2xl xl:mr-28 lg:mr-10 ">
          تعديل الملف الشخصى
        </p>
        <div>{""}</div>
      </div>
...
export default connect(mapStateToProps, { uploadImg, Get_Edit_Specialist })(
  FormEditDoctor
);
